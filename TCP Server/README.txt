...
So far I've tested NXT Python 2.2.2 on Mac with LightBlue with Python 2.7 which resulted in one syntax error and another runtime error. Luckily these were fixable.
